...
Check this [online demo](https://jmcrafter26.github.io/jellify-ur-website/) as well as see how it works.
...
3. Add a new bookmark to your browser with the following code:
    ...
    ```javascript
    javascript:["https://cdn.jsdelivr.net/npm/matter-js@0.17.1/build/matter.min.js","http://localhost:5500/src/jellify.js"].forEach(t=>{const e=document.getElementsByTagName("head")[0],a=document.createElement("script");a.src=t,e.appendChild(a)});
    ```
